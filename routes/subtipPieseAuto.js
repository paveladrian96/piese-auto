...
const {create, subtipPieseAutoById, update , remove, read, list, photo, listRelatedByName, piesaByTip
    ,getPieseByTipPiesa, listSorted, listBySearch, listSearch, getPieseByDistribuitor} = require('../controllers/subtipPieseAuto')

const {requireSignin , isAuth, isAdmin} = require("../controllers/auth")
const { userById } = require('../controllers/user')
const { tipPieseAutoById } = require('../controllers/tipPieseAuto')
const {distribuitoriById} = require('../controllers/distribuitori')
...
router.get("/subtipPieseAuto/by/distribuitor/:distribuitoriId", getPieseByDistribuitor)
